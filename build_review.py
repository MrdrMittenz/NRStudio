...
compile('NRStudio.exe',['AssemblyInfo.cs','Core.cs','Prerequisites.cs','RuntimeDiagnostics.cs','GpuMonitor.cs','Performance.cs','Help.cs','App.cs'])
...
compile('GpuMonitorTests.exe',['GpuMonitor.cs','GpuMonitorTests.cs'],True)
compile('FeederTests.exe',['Core.cs','FeederTests.cs'],True)
if args.payload:
